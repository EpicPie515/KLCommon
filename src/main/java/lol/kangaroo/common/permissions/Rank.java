...
public enum Rank {
	...
	KANGAROOPLUS(64, 7, 55, ChatColor.LIGHT_PURPLE, "Kanga+", "Kanga+", "kmc.kangaplus",  ChatColor.LIGHT_PURPLE + "%1$s[" + ChatColor.LIGHT_PURPLE + "KANGAROO" + ChatColor.DARK_PURPLE + "%2$s+" + ChatColor.LIGHT_PURPLE + "%1$s]" + ChatColor.LIGHT_PURPLE + " ", true),
	...
	OGKANGAROO(67, 7, 41, ChatColor.LIGHT_PURPLE, "Kangaroo OG", "Kangaroo", "kmc.kangaplus", ChatColor.LIGHT_PURPLE + "%1$s[" + ChatColor.BLUE + "KANGAROO" + ChatColor.LIGHT_PURPLE + "%1$s]" + ChatColor.LIGHT_PURPLE + "%2$s ", true),
